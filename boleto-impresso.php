...
<html lang="pt-br">
  ...
  <body>
    ...
    $result_mensagens = "SELECT * FROM vendas WHERE formaPagamento='boleto' AND statusVenda='Aguardando pagamento' AND validacao='enviado' AND id_user='".$_SESSION['id_user']."' ORDER BY id DESC LIMIT $inicio, $qnt_result_pg";
